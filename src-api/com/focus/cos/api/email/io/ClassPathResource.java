...
import com.focus.cos.api.ClassUtils;
import com.focus.cos.api.ObjectUtils;
import com.focus.cos.api.ResourceUtils;
...
public class ClassPathResource extends AbstractResource
{
	...
	public boolean equals(Object obj)
	{
		...
		if (obj instanceof ClassPathResource)
		{
			...
			return (this.path.equals(otherRes.path) && ObjectUtils.nullSafeEquals(this.classLoader, otherRes.classLoader) && ObjectUtils
