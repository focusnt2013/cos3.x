...
public class CrwalBooks {

	public static void main(String[] args) {
		JSONArray array = new JSONArray();
		try {
//			parse(crwal(1, "冰与火之歌", null), array);
			parse(crwal(2, null, "重庆出版社"), array);
		} catch (Exception e) {
			e.printStackTrace();
		}
		try {
			IOHelper.writeFile(new File("D:/focusnt/clc/trunk/DESIGN/数据用例/case_文字_小说_冰与火之歌/3其它/5官方登记/官方原始数据.json"), 
