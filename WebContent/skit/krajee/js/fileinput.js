...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _init: function (options, refreshMode) {
            ...
            self.isAjaxUpload = $h.hasFileUploadSupport() && (!$h.isEmpty(self.uploadUrl)||(typeof self.uploadUrl == 'function'));
        ...
        _initTemplateDefaults: function () {
            ...
            tActionUpload = '<button type="button" id="btn-upload-file" class="kv-file-upload {uploadClass}" title="{uploadTitle}">' +
                '{uploadIcon}</button>';
...
//        	alert("_uploadClick");
            ...
            fnSuccess = function (data, textStatus, jqXHR) {
                ...
                setTimeout(function () {
                    if ($h.isEmpty(data) || $h.isEmpty(data.error)) {
                        ...
                        uploadFailed = true;
                        //alert("uploadFailed:="+uploadFailed);
        ...
        _initPreviewActions: function () {
            ...
            $preview.find(btnRemove).each(function () {
                var $el = $(this), vUrl = self.deleteUrl || $el.data('url'), vKey = $el.data('key'), errMsg, fnBefore,
                    fnSuccess, fnError, op = self.ajaxOperations.deleteThumb;
                if ( vUrl && typeof vUrl === 'function') {
                    vUrl = vUrl();
                }
        ...
        readFiles: function (files) {
            ...
            readFile = function (i) {
                ...
                reader.onload = function (theFile) {
                	...
                	self._initFileActions();
                    processFileLoaded();
                    if( self.options.multiFileUpload ){
                    	var fileId = self.fileManager.getId(file);
                        var $thumb = self.fileManager.getThumb(fileId);
                        var $btnUpload = $thumb.find('.kv-file-upload');
                        var $btnDelete = $thumb.find('.kv-file-remove');
                        $btnUpload.hide();
                        $btnDelete.hide();
