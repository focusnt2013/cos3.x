...
<div class='ui-tabs .ui-tabs-panel' style='padding:10px 10px'>
		...
		<div class="panel-body" style='padding-bottom:0px;'>
			<div class="form-group">
				<div class="input-group">
					<span class="input-group-addon input-group-addon-font">程序标识<span class='fa fa-user-secret' style='margin-left:6px'></span></span>
					<input class="form-control form-control-font" id="programid" type="text"
			...
			<div class="form-group">
				<div class="input-group">
					<span class="input-group-addon input-group-addon-font">程序名称<span class='fa fa-info-circle' style='margin-left:6px'></span></span>
					<input class="form-control form-control-font" type="text" id='name'
			...
			<div class="form-group">
				<textarea class="form-control form-control-font" rows="2"	id="description" style='color:#66cccc;background-color:#eee;'
			...
			<div class="form-group">
				<div class="input-group" style='width:440px'>
					<span class="input-group-addon input-group-addon-font">程序管理员<span class='fa fa-user-secret' style='margin-left:6px'></span></span>
					<input class="form-control form-control-font" type="text"	id='programmer' readonly style='width:128px;height:34px;'
					...
					<span class="input-group-addon input-group-addon-font" style='border-left: 0px solid #eee;border-right: 0px solid #eee;'
						>邮箱<span class='fa fa-at' style='margin-left:6px'></span></span>
					<input class="form-control form-control-font" type="text"	style='width:256px;height:34px;' id='email' readonly>
			...
			<div class="form-group">
				<div class="input-group" style='width:240px'>
					...
					<input class="form-control form-control-font" type="text" readonly id='version'
                	data-title='请按照1.0.0.0格式输入版本号或者选择版本'
					data-toggle="tooltip" 
					data-placement="bottom"
					data-trigger='manual'
					onblur='this.readOnly=true;var val=this.value;$("#version").inputmask("remove");this.value=val;if(val){document.getElementById("divVersion").style.display="";}'
					...
					>
      				<div class="input-group-btn">
      					...
      					<ul class='dropdown-menu pull-right animated fadeInUp' id='ulVersions' style='height:128px;cursor:pointer;'>
      					</ul>
      				</div>
				</div>
			</div>
			<div class="form-group" id='divVersion'>
				<textarea class="form-control form-control-font" rows="2"
				    ...
				    data-title='请输入当前版本特性说明'
					data-toggle="tooltip" 
					data-placement="bottom"
					data-trigger='manual'
					onkeydown='$("#versionremark").tooltip("hide")'
		...
		<div class="panel-body" style='padding-bottom:0px;'>
			<div class="form-group">
     			<div class="input-group" style='display:'>
					<span class="input-group-addon input-group-addon-font" id='spanMode'>主控启动<i class='fa fa-globe' style='margin-left:6px'></i></span>
					<select class="form-control form-control-font" style='font-size:12px' onchange='changeMode()' id='mode'>
			...
			<div class="form-group" id='div-logfile'>
				<div class="input-group">
					<span class="input-group-addon input-group-addon-font">日志路径<i class='fa fa-file-text' style='margin-left:6px'></i></span>
					<input class="form-control form-control-font" type="text" id='logfile' readonly
			...
			<div class="form-group" id='div-pidfile'>
				<div class="input-group">
					<span class="input-group-addon input-group-addon-font">PID文件<span class='fa fa-credit-card' style='margin-left:6px'></span></span>
					<input class="form-control form-control-font" type="text" id='pidfile' readonly
			...
			<div class="form-group" id='div-control'>
   				<div class="input-group" style='width:222px;float:left;' title='如果服务中断间隔多少时间被主控重启。缺省不等候马上重启'>
					...
					<input class="form-control form-control-font" type="text" id='restartup' readonly
	                	...
	                	placeholder="">
					<span class="input-group-addon input-group-addon-font" style='border-left: 1px solid #eee;border-right: 1px solid #eee;'>秒</span>
				...
				<div class="input-group" style='width:222px;padding-left:10px;' title='程序将在主控启动后指定时间后启动'>
					<span class="input-group-addon input-group-addon-font">延迟启动<span class='fa fa-group' style='margin-left:6px'></span></span>
					<input class="form-control form-control-font" type="text" id='delayed' readonly
			...
			<div class="form-group">
     			<div class="input-group">
					<span class="input-group-addon input-group-addon-font">启动依赖<span class='fa fa-credit-card' style='margin-left:6px'></span></span>
					<select class="form-control form-control-font" id='dependence'>
					<option value=''></option>
			...
			<div class="form-group" id='div-forcereboot' style='display:none'>
   				<div class="input-group" style='width:202px;'>
					...
					<input class="form-control form-control-font" type="text"
					...
					<span class="input-group-addon input-group-addon-font" style='border-right: 1px solid #eee;'>强制重启程序开关<span class='fa fa-toggle-on' style='margin-left:6px'></span></span>
					<span class='input-group-addon' style='border-left: 1px solid #eee;'>
						<div class='checkbox checkbox-info' style='padding-left: 0px'>
			...
			<div class="form-group" id='div-timerange'>
				<div class="input-group" style='width:360px' title='该参数可用于某些服务进程每天只在指定时间内运行的程序，例如08:00~09:00。同时配置在时间到期是否强制关闭'>
					<span class="input-group-addon input-group-addon-font"><i class='fa fa-at' style='margin-right:6px'></i>每天从</span>
					<input class="form-control form-control-font" type="text"
						placeholder="00:00"
					...
					<span class="input-group-addon input-group-addon-font"> 到 </span>
					<input class="form-control form-control-font" type="text"
						placeholder="23:59" 
						id='endtime' readonly
					...
					<span class="input-group-addon input-group-addon-font" style='border-right: 1px solid #eee;'>允许运行程序，在此时间范围之外强制关闭程序<span class='fa fa-toggle-on' style='margin-left:6px'></span></span>
					<span class='input-group-addon' style='border-left: 1px solid #eee;'>
	...
	<div class="panel panel-default">
		...
		<div class="panel-body" style='padding-bottom:0px;'>
			...
			<td width="40%">
			<textarea class="form-control form-control-font" rows="2" placeholder='请按行输入命令备注'
...
function changeMode(init)
{
	...
	case 0:
		...
		document.getElementById( "div-pidfile" ).style.display = "none";
		break;
	case 1:
		modeindex = 1;
...
{
	var date = timeline[i];
	document.getElementById("version").value= date.version;
	document.getElementById("versionremark").value= date.text;
}
try
{
	...
	if( json != "" )
	{
		...
		document.getElementById( "versionremark" ).value = config["versionremark"]?config["versionremark"]:"";
		...
		if( timeline )
		{
			...
			{
				var date = timeline[i];
				html += "<li><a onclick='changeVersion("+i+")' style='font-size:9pt;padding:2px 10px;'>" + date.version + "</a></li>";
			}
			ul.innerHTML = html;
		}
		...
		document.getElementById( "programmer" ).value = maintenance.programmer?maintenance["programmer"]:"";
		document.getElementById( "manager" ).value = maintenance.manager?maintenance["manager"]:"";
		document.getElementById( "email" ).value = maintenance.email?maintenance["email"]:"";
...
function setProgramConfig()
{
	...
	try
	{
	    ...
	    config["versionremark"] = document.getElementById( "versionremark" ).value;
	    if( config.versionremark == "" )
	    {
			$("#versionremark").tooltip("show");
			document.getElementById( "versionremark" ).focus();
		    return;
	    }
		...
		//skit_alert(json);
		parent.setProgramConfig(json);
	}
	catch(e)
	{
		skit_alert("保存程序配置出现异常在"+e.message+", 行数"+e.lineNumber);
	}
}
</SCRIPT>
</html>